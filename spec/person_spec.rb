...
describe Person do
  ...
  before { subject.create_account }
     ...
     it 'can withdraw funds' do
       command = lambda { subject.withdraw(amount: 100, pin: '1234', account: subject.account, atm: atm) }
     ...
     it 'funds are added to cash - deducted from account balance' do
       subject.cash = 100
       subject.withdraw(amount: 100, pin: '1234', account: subject.account, atm: atm)
